# Ad hoc Questions
Some random questions and answers that I might want to reference later.

## Writing Algorithms
### How to start
Write the first thing that comes to mind. To go through every element in a list or set or dictionary, use a for-loop. 
