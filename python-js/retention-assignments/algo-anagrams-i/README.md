...
For this challenge you will make a program that takes in two different strings and see if the individual letter or number characters in a string match in both strings. For example, 'abcde2' can be rearranged to 'c2abed'.
